...
source('D:/stego web/web-construction FINAL round - raw data/analysis-FINALround/analysis-scripts/smoothworkflow/multiplot.R')

# pixpm --> is the scaling factor from pixels --> metres.

# common address:

comad<-'D:/stego web/web-construction FINAL round - raw data/analysis-FINALround/analysis-results/semifinal_16May/'
...
wtadrs<-'D:/stego web/web-construction FINAL round - raw data/analysis-FINALround/analysis input-data/finalwtsnsizes.csv' # address of the weights and sizes csvfile
wts<-read.csv(wtadrs)
...
save_folder = 'D:\\stego web\\web-construction FINAL round - raw data\\analysis-FINALround\\analysis-results\\feb_2016_Rmdfiles\\'

save_filename = as.character('64grid_raw.Rda')
final_path = paste(save_folder,save_filename,sep='')
saveRDS(m64,file=final_path)
