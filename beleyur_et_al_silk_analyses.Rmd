---
title: "Figures and analysis for Beleyur et al 2020"
author: "Thejasvi"
...
###This is a whole bunch of  analyses+plots of social spider web construction.  
...
# removes all rows in the colonynames list/vector
remove_excess_colonies <- function(df, colonynames)
  {
  dfcopy <- df
  
  for (each in colonynames)
  {
    dfcopy <- subset(dfcopy, colonyname!=each)
...
wd <- remove_excess_colonies(wd, colonies_to_remove)
